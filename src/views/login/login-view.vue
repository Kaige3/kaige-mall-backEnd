...
import type { UserLoginInput } from '@/apis/__generated/model/static/UserLoginInput'
...
//    try {
//     const res = await api.userForFrontController.login({ body: loginForm });
