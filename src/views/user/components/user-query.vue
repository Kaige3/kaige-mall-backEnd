<script lang="ts" setup>
  ...
  import { DictConstants,Dictionaries } from '@/apis/__generated/model/enums/DictConstants'
...
<template>
  <div class="search">
    ...
    <el-form-item label="性别">
                <dict-select :dict-id="DictConstants.SEX" v-model="query.gender"></dict-select>
    </el-form-item>
      <el-form-item label=" ">
