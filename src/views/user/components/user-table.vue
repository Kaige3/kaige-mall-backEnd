...
<script lang="ts" setup>
    ...
    import type { UserInput } from '@/apis/__generated/model/static'
    import { Delete, Edit, Plus } from '@element-plus/icons-vue'
    import DictColumn from '@/components/dict/dict-column.vue'
    import { DictConstants } from '@/apis/__generated/model/enums/DictConstants'
    type UserScope = Scope<UserDto['UserRepository/USER_ROLE_FETCHER']>
    ...
    const handleDelete = (ids: string[]) => {
        ElMessageBox.confirm('此操作将删除数据且无法恢复, 是否继续?', '警告', {
            ...
            api.userForFrontController.delete({body: ids}).then((res) => {
...
<template>
    ...
    <el-table-column label="性别" prop="gender" sortable="custom">
        <template v-slot:default="{row}:UserScope">
                    <dict-column :dict-id="DictConstants.SEX" :value="row.gender"></dict-column>
        </template>
    </el-table-column>
