<script lang="ts" setup>
    ...
    const {createForm, dialogData} = storeToRefs(dictInputStore)
    ...
    const handleConfirm = () => {
        createFormRef.value?.validate(
            assertFormValidate(() =>
                api.dictInputController.save({body: createForm.value}).then(async (res) => {
...
<template>
    ...
    <el-form-item label="是否可见" prop="isVisible">
                <el-input-number v-model="createForm.isVisible"></el-input-number>
    </el-form-item>
        </el-form>
